...
namespace Assets
{
    public static class SpecialAttacks
    {
        public static void SniperStrike(Soldier executor, LivingEntity target)
        {
            ...
            ProjectilesController.Instance.InitializeProjectile(damage, executor.DamageType, executor.Position, target, () => { });
        }
        ...
        public static void RocketAttack(Soldier executor, EnemiesController controller, LivingEntity target)
        {
            ...
            ProjectilesController.Instance.InitializeProjectile(dmg, executor.DamageType, executor.Position, target,
                () =>
                {
                    var collection =
